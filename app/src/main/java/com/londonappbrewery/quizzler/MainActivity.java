...
public class MainActivity extends Activity {
    ...
    private void updateQuestion() {
        ...
        if (mIndex == 0) {
            ...
            alert.setMessage("You scored " + mUserScore + " points!");
            alert.setPositiveButton(R.string.alert_close, new DialogInterface.OnClickListener() {
                @Override
    ...
    private void checkAnswer(boolean userSelection) {
        boolean correctAnswer = mQuestionBank[mIndex].isRightAnswer();
